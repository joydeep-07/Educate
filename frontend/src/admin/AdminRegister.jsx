...
const AdminRegister = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (email === "admin@gmail.com") {
      // Example action – you can replace with actual dispatch
        ...
        <div className="w-1/2 p-12 bg-white flex flex-col justify-center relative">
          <div className="z-10">
            ...
            <p className="text-gray-500 text-sm mb-8">
              Enter your email to create an admin account
            </p>
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-500 transition"
                    required
